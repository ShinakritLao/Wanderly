...
const Profile = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.circleContainer, { alignItems: 'center', paddingBottom: 24 }]}> 
        <TouchableOpacity onPress={pickImage} style={[styles.circle, { width: 110, height: 110, borderRadius: 55 }]}> 
          <Image
        ...
        <View style={[styles.textContainer, { alignItems: 'center', marginBottom: 16 }]}> 
          <View style={styles.nameRow}>
            <Text style={[styles.boldText, { fontSize: 22 }]}>{name || 'User'}</Text>
            <TouchableOpacity onPress={openEditModal} style={styles.editButton}>
              <Text style={styles.editIcon}>✏️</Text>
            </TouchableOpacity>
          </View>
          <Text style={[styles.normalText, { fontSize: 15 }]}>{email || 'No email'}</Text>
        </View>
        {/* Menu Items */}
        <View style={[styles.menuContainer, { width: 270 }]}> 
        ...
        {/* Logout Button */}
        <TouchableOpacity style={[styles.logoutButton, { width: 270, marginTop: 10 }]} onPress={handleLogout}>
