...
test('E2E-001: User cannot log in with invalid password', async ({ page }) => {
...
test('E2E-002: User cannot log in with empty fields', async ({ page }) => {
  // Step 1: Open the web app
  await page.goto('https://amazing-gingersnap-d4b59a.netlify.app/');
...
test('E2E-003: User can log out successfully', async ({ page }) => {
  // Step 1: Open the web app
